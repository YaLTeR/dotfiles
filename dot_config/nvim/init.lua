...
vim.keymap.set('n', '<C-ы>', vim.cmd.update)
vim.keymap.set('n', '<F5>', function()
  vim.cmd.edit('%')
end)
vim.keymap.set('n', 'U', vim.cmd.redo)
vim.keymap.set('n', 'Г', vim.cmd.redo)
vim.keymap.set('n', '<A-l>', ':nohlsearch<CR>:diffupdate<CR>:syntax sync fromstart<CR><C-L>')
vim.keymap.set('n', '<A-д>', ':nohlsearch<CR>:diffupdate<CR>:syntax sync fromstart<CR><C-L>')
vim.keymap.set('n', '<A-z>', ':set invwrap<CR>')
vim.keymap.set('n', '<A-я>', ':set invwrap<CR>')
vim.keymap.set('n', 'Q', '@@')
vim.keymap.set({ 'n', 'x', 'o' }, 'gl', '$')
vim.keymap.set({ 'n', 'x', 'o' }, 'пд', '$')
vim.keymap.set({ 'n', 'x', 'o' }, 'gh', '0')
vim.keymap.set({ 'n', 'x', 'o' }, 'пр', '$')
vim.keymap.set({ 'n', 'x', 'o' }, 'ge', 'G')
vim.keymap.set({ 'n', 'x', 'o' }, 'пу', '$')
vim.keymap.set('v', '>', '>gv')
vim.keymap.set('v', '<', '<gv')
